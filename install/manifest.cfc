<cfcomponent extends="farcry.core.webtop.install.manifest" name="manifest">
	...
	<cfset this.aVersions = [
	{
		...
		"description"="",
		"changelog"="<ul><li>Bug fixes</li><li>Performance increases</li><li>Allow sorting by FarCry label field</li><li>Upgrade Tika to 1.14</li></ul>",
		"downloads"=[
			{
		...
		"repository"={
			"url"="https://github.com/jeffcoughlin/farcrysolrpro/tree/1.5.0"
		}
	},
	{
		"version"="1.4.1",
